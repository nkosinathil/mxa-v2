...
CLIENT_ID="${KEYCLOAK_CLIENT_ID:-mxa-mobile-web}"
APP_BASE_URL="${APP_BASE_URL:-http://192.168.1.66}"
REDIRECT_URI="${KEYCLOAK_REDIRECT_URI:-${APP_BASE_URL%/}/auth/callback}"
WEB_ORIGINS="${KEYCLOAK_WEB_ORIGINS:-$APP_BASE_URL}"
